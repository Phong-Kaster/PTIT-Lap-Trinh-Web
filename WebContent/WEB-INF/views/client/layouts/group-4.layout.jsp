...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <div class="wi-section fox-section section-layout-group-4 section-stretch-content show_on_desktop show_on_tablet show_on_mobile section-fullwidth">
                                       ...
                                       <div class="post-item-inner grid-inner post-grid-inner">
                                          <figure class="wi-thumbnail fox-thumbnail post-item-thumbnail fox-figure  grid-thumbnail thumbnail-acute hover-none">
                                             <div class="thumbnail-inner">
                                                ...
                                                <img width="720" height="480" src="${post.media}" class="attachment-thumbnail-large size-thumbnail-large" alt="" loading="lazy" srcset="${post.media}">
                                                </span>
                                                </a>
                                             </div>
                                          </figure>
                                       ...
                                       <div class="post-item-inner grid-inner post-grid-inner">
                                          <figure class="wi-thumbnail fox-thumbnail post-item-thumbnail fox-figure  grid-thumbnail thumbnail-acute  hover-none">
                                             <div class="thumbnail-inner">
                                                <a href="${APPURL}/article/${post.id}/${post.post_slug}.htm" class="post-link">
                                                <span class="image-element">
                                                <img width="300" height="200" src="${post.media}" class="attachment-medium size-medium" alt="" loading="lazy" srcset="${post.media}">
                                                </span>
                                                </a>
                                             </div>
                                          </figure>
